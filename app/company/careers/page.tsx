...
//                 image: "/careers1.jpeg?height=100&width=100",
...
import { useState } from "react"
import { ArrowRight, Search, MapPin, Briefcase, Clock, ChevronDown, ChevronUp, Sparkles, Users, TrendingUp, Award, Globe, Zap } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Input } from "@/components/ui/input"
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select"
...
const jobListings = [
  {
    ...
    location: "Indore, MP",
    type: "Full-time",
    description: "We're looking for a Senior React Developer to join our engineering team and help build innovative web applications for our clients.",
    requirements: [
      "5+ years of experience with React and modern JavaScript",
      "Experience with Next.js, TypeScript, and state management libraries",
      "Strong understanding of web performance optimization",
  ...
  },
  {
    ...
    type: "Full-time",
    description: "We're seeking a talented UX/UI Designer to create beautiful, intuitive interfaces for our digital products and services.",
    requirements: [
      "3+ years of experience in UX/UI design for web and mobile applications",
      "Proficiency in design tools such as Figma, Sketch, or Adobe XD",
      "Strong portfolio demonstrating user-centered design process",
  ...
  },
  {
    ...
    location: "Pune, Maharashtra",
    type: "Full-time",
    description: "We're seeking a Product Manager to lead the development of innovative digital products that solve real customer problems.",
    requirements: [
      "3+ years of experience in product management for software products",
      "Strong understanding of product development lifecycle",
      "Experience with agile methodologies",
  ...
  },
  {
    ...
    location: "Indore, MP",
    type: "Full-time",
    description: "We're looking for a Data Scientist to help us extract insights from data and build machine learning models to solve business problems.",
    requirements: [
      "Master's or PhD in Computer Science, Statistics, or related field",
      "3+ years of experience in data science or machine learning",
      "Proficiency in Python and data science libraries (NumPy, Pandas, Scikit-learn)",
  ...
  },
  {
    ...
    location: "Indore, MP",
    type: "Full-time",
    description: "We're seeking a Marketing Specialist to help us promote our products and services to target audiences.",
    requirements: [
      "3+ years of experience in digital marketing",
      "Experience with content marketing, social media, and email campaigns",
      "Knowledge of SEO/SEM and analytics tools",
  ...
  return (
    <main className="min-h-screen bg-white">
        ...
        <div className="container px-4 mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Join a team of talented individuals working on innovative projects that make a real impact.
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container px-4 mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900">Why Join MHLP?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              We offer a great work environment with opportunities for growth and development.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: "Innovation", description: "Work on cutting-edge projects with modern technologies.", icon: Zap },
              { title: "Global Impact", description: "Your work reaches users across the globe.", icon: Globe },
              { title: "Career Growth", description: "Learning opportunities and mentorship programs.", icon: TrendingUp },
              { title: "Great Benefits", description: "Health coverage, equity, and competitive pay.", icon: Award },
              { title: "Diverse Team", description: "Inclusive environment with talented people.", icon: Users },
              { title: "Work-Life Balance", description: "Flexible hours and remote-friendly.", icon: Sparkles },
            ].map((benefit, index) => {
          ...
          <div className="mb-8 bg-white border border-gray-200 p-6 rounded-lg shadow-sm">
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Select value={departmentFilter} onValueChange={setDepartmentFilter}>
                  <SelectTrigger className="w-full sm:w-44 border-gray-300">
                    <SelectValue placeholder="Department" />
                  </SelectTrigger>
                  <SelectContent>
                    {departments.map((dept) => (
      ...
      <section className="py-16 bg-white">
        <div className="container px-4 mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900">What Our Team Says</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Hear from our employees about their experience at MHLP.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                quote: "Working at MHLP has been great. The projects are challenging and the team is supportive.",
                name: "Rahul Sharma",
                position: "Senior Developer",
                years: "3 years",
              },
              {
                quote: "I appreciate the work-life balance and opportunities to learn new technologies.",
                name: "Priya Patel",
                position: "UX Designer",
                years: "2 years",
              },
              {
                quote: "The inclusive culture makes it a great place to work. Everyone's ideas are valued.",
                name: "Arjun Kumar",
                position: "Product Manager",
                years: "4 years",
              },
              ...
              <div key={index} className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">{testimonial.position} • {testimonial.years}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-20 bg-blue-600">
        <div className="container px-4 mx-auto text-center">
          ...
          <p className="text-blue-100 max-w-2xl mx-auto mb-8">
            Explore our open positions and start your journey with MHLP today.
          </p>
          <a href="#open-positions">
